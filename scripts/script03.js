...
function getGlobalRegAddr( primary ) {
  return admin.setGlobalRegistrar("", primary);
}

function getHashRegAddr( primary ) {
  return admin.setHashReg("", primary);
}

function getUrlHint( primary ) {
  return admin.setUrlHint("", primary )
}
